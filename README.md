...
VIBER - заблокированы подсети на хосте compute.amazonaws.com, в список TEST2 добавлено несколько адресов, но далеко не все(работает на маленьких расстояниях между абонентами)
