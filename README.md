...
VIBER - заблокированы подсети amazon, в папку services добавлены CIDR на Frankfurt(основной пул Европы), которые желательно пускать через другой прокси. Также при звонках вызывается большой американский пул, поэтому 18.184.0.0/13,
18.192.0.0/13

Все диапазоны Amazon можно посмотреть здесь https://ip-ranges.amazonaws.com/geo-ip-feed.csv

P.S. на данный момент Viber для медиаконтента использует подсети Google Cloud:
