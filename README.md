...
VIBER - заблокированы подсети amazon, в папку services добавлены CIDR на Frankfurt(основной пул Европы), желательно кидать через другой прокси

Все диапазоны можно посмотреть здесь https://ip-ranges.amazonaws.com/geo-ip-feed.csv

P.S. на данный момент Viber дополнительно использует подсети Google Cloud:
